package cn.abtion.taskgo.mvp.view.task.fragment.myaccept;
...
/**
 * @author fhyPayaso
 * @since 2018/2/3 on 上午9:38
 * fhyPayaso@qq.com
 */
public class MyAcceptFinishedFragment extends BasePresenterFragment<MyTaskListContract.Presenter> implements TaskItemListener,
    ...
    protected int getLayoutId() {
        return R.layout.fragment_my_accept_finished;
    }
        ...
        new Timer().schedule(new TimerTask() {
            ...
            public void run() {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        mPresenter.loadMyAcceptTaskList(2);
                    }
                });
            }
        }, Config.REFRESH_TIME);
